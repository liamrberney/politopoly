...
public class Board {
    ...
    public static Space[] initializeSpaces() {
        ...
        spaces[1]= new Property(1,"MEDITERANEAN AVENUE","BROWN",60,new int[]{2,10,20,90,160,250});
        spaces[2]= new otherSpace(2,"COMMUNITY CHEST","COMMUNITYCHEST");
        spaces[3]= new Property(3,"BALTIC AVENUE","BROWN",60,new int[]{4,20,60,180,320,450});
        ...
        spaces[16]= new Property(16,"ST. JAMES PLACE","ORANGE",180,new int[]{14,70,200,550,750,950});
        spaces[17]= new otherSpace(17,"COMMUNITY CHEST","COMMUNITYCHEST");
        spaces[18]= new Property(18,"TENNESSEE AVENUE","ORANGE",180,new int[]{14,70,200,550,750,950});
        ...
        spaces[32]= new Property(32,"NORTH CAROLINA AVENUE","GREEN",300,new int[]{26,130,390,900,1100,1275});
