...
public class Board {
    ...
    public static Space[] initializeSpaces() {
        ...
        spaces[1]= new Property(1,"MEDITERANEAN AVENUE","BROWN",60,new int[]{2,4,10,20,90,160,250});
        spaces[2]= new otherSpace(2,"COMMUNITY CHEST","COMMUNITYCHEST");
        spaces[3]= new Property(3,"BALTIC AVENUE","BROWN",60,new int[]{4,8,20,60,180,320,450});
        spaces[4]= new otherSpace(4,"INCOME TAX","TAX");
        spaces[5]= new Property(5,"READING RAILROAD","RAILROAD",200,new int[]{25,50,100,200});
        spaces[6]= new Property(6,"ORIENTAL AVENUE","LIGHTBLUE",100,new int[]{6,12,30,90,270,400,550});
        spaces[7]= new otherSpace(7,"CHANCE","CHANCE");
        spaces[8]= new Property(8,"VERMONT AVENUE","LIGHTBLUE",100,new int[]{6,12,30,90,270,400,550});
        spaces[9]= new Property(9,"CONNECTICUT AVENUE","LIGHTBLUE",120,new int[]{8,16,40,100,300,450,600});
        spaces[10]= new otherSpace(10,"JAIL","DONOTHING");
        spaces[11]= new Property(11,"ST. CHARLES PLACE","PURPLE",140,new int[]{10,20,50,150,450,625,750});
        spaces[12]= new otherSpace(12,"ELECTIONS","ELECTIONS");
        spaces[13]= new Property(13,"STATES AVENUE","PURPLE",140,new int[]{10,20,50,150,450,625,750});
        spaces[14]= new Property(14,"VIRGINIA AVENUE","PURPLE",160,new int[]{11,22,60,180,500,700,900});
        spaces[15]= new Property(15,"PENNSYLVANIA RAILROAD","RAILROAD",200,new int[]{25,50,100,200});
        spaces[16]= new Property(16,"ST. JAMES PLACE","ORANGE",180,new int[]{14,28,70,200,550,750,950});
        spaces[17]= new otherSpace(17,"COMMUNITY CHEST","COMMUNITYCHEST");
        spaces[18]= new Property(18,"TENNESSEE AVENUE","ORANGE",180,new int[]{14,28,70,200,550,750,950});
        spaces[19]= new Property(19,"NEW YORK AVENUE","ORANGE",200,new int[]{16,32,80,220,600,800,1000});
        spaces[20]= new otherSpace(20,"FREE PARKING","DONOTHING");
        spaces[21]= new Property(21,"KENTUCKY AVENUE","RED",220,new int[]{18,36,90,250,700,875,1050});
        spaces[22]= new otherSpace(22,"CHANCE","CHANCE");
        spaces[23]= new Property(23,"INDIANA AVENUE","RED",220,new int[]{18,36,90,250,700,875,1050});
        spaces[24]= new Property(24,"ILLINOIS AVENUE","RED",240,new int[]{20,40,100,300,750,925,1100});
        spaces[25]= new Property(25,"B&O RAILROAD","RAILROAD",200,new int[]{25,50,100,200});
        spaces[26]= new Property(26,"ATLANTIC AVENUE","YELLOW",260,new int[]{22,44,110,330,800,975,1150});
        spaces[27]= new Property(27,"VENTNOR AVENUE","YELLOW",260,new int[]{22,44,110,330,800,975,1150});
        spaces[28]= new otherSpace(28,"MIDTERMS","ELECTIONS");
        spaces[29]= new Property(29,"MARVIN GARDENS","YELLOW",280,new int[]{24,48,120,360,850,1025,1200});
        spaces[30]= new otherSpace(30,"GO TO JAIL","GOTOJAIL");
        spaces[31]= new Property(31,"PACIFIC AVENUE","GREEN",300,new int[]{26,52,130,390,900,1100,1275});
        spaces[32]= new Property(32,"NORTH CAROLINA AVENUE","GREEN",300,new int[]{26,52,130,390,900,1100,1275});
        spaces[33]= new otherSpace(33,"COMMUNITY CHEST","COMMUNITYCHEST");
        spaces[34]= new Property(34,"PENNSYLVANIA AVENUE","GREEN",320,new int[]{28,56,150,450,1000,1200,1400});
        spaces[35]= new Property(35,"SHORT LINE","RAILROAD",200,new int[]{25,50,100,200});
        spaces[36]= new otherSpace(36,"CHANCE","CHANCE");
        spaces[37]= new Property(37,"PARK PLACE","BLUE",350,new int[]{35,70,175,500,1100,1300,1500});
        spaces[38]= new otherSpace(38,"LUXURY TAX","TAX");
        spaces[39]= new Property(39,"BOARDWALK","BLUE",400,new int[]{50,100,200,600,1400,1700,2000});
        return spaces;
    }
